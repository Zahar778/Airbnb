...
import Additional_power from "./component/Additional_power";
import Clients_profiles from "./component/Clients_profiles";
...
function App() {
  ...
  return <Page>
      ...
      <Description title="Про сусiдiв" children={data.neighborhood_info}/>
  ...
  <Clients_profiles list={data.guestReviews}/>
